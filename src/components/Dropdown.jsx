    ...
    <div className="nested-dropdown">
      ...
      >
        <div className="submenu">
          {/* <a href="#" className="text-med relative border-0 leading-1vw text-[#0c527b] hover:text-black font-[500] transition-colors duration-150 ease-linear">
            Medical Housing
          ...
          {isOpen && (
            ...
            >
              <img
                ...
                className="-right-12 relative"
              />
              <div className="bg-black opacity-80 text-white w-full relative right-5 z-10">
