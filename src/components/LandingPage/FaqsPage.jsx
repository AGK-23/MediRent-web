    ...
    return (
        <div className='md:mt-[5rem] xs:mt-[5rem]'>
            <div className=' '>
                ...
                <section
                    className=" 
                    flex justify-center items-center md:mt-10 xs:mt-12  w-full"
                >
                    <div className="flex flex-col justify-center items-center w-full">
                        <div className="relative z-10 grid md:grid-cols-2 xs:grid-cols-1 gap-10 w-full">
                            ...
                            <div className=" w-full mb-3 md:px-0 xs:px-0 text-black flex-col font-normal md:mb-7 xs:mb-3 flex  justify-center items-center text-center mt-[0px]">
