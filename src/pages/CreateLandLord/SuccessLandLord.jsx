            ...
            <div className="flex flex-col mx-3">
                <div className="flex flex-col items-center  p-4  mb-4 rounded-xl">
                    ...
                    <div className="flex justify-center items-center flex-col w-full  p-2 rounded ">
                        ...
                        <Link to="/admin/dashboard/landlord"   className="flex justify-center items-center z-10 relative bg-third text-white md:text-sm rounded-lg md:py-3 md:px-16 xs:text-[10px] xs:py-3 xs:px-10">
